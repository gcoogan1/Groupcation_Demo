...
export const boatSchema = z
  .object({
    boatCruiseLine: z
      .string({ required_error: "Name of boat / cruise line is required." })
      .nonempty("Name of boat / cruise line is required.")
    ...
    departureDock: z
      .string({ required_error: "Departure dock is required." })
      .nonempty("Departure dock is required.")
      .min(4, "Must have at least 4 characters."),
    departureDate: z.date({ required_error: "Departure date is required." }),
    departureTime: z.date({ required_error: "Departure time is required." }),
    arrivalDock: z
      .string({ required_error: "Arrival dock is required." })
      .nonempty("Arrival dock is required.")
      .min(4, "Must have at least 4 characters."),
