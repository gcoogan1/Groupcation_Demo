...
import {
  ...
  deleteStayAttachment,
  deleteStayTable,
  deleteStayTraveler,
  fetchStayByGroupcationId,
  fetchStayTable,
  updateStayTable,
...
const staySlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      // ADD NEW STAY
      .addCase(addStayTable.fulfilled, (state, action: PayloadAction<Stay>) => {
      ...
      .addCase(
        ...
        (
          ...
          // Find the stay
          const stay = state.stays.find((t) => Number(t.id) === Number(stayId));
          if (stay) {
      ...
      .addCase(
        ...
        (
          ...
          const stay = state.stays.find((t) => String(t.id) === String(stayId));
